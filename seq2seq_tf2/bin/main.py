...
def main():
    ...
    parser.add_argument("--train_seg_x_dir", default='{}/datasets/train_set.seg_x_dev.txt'.format(BASE_DIR), help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir", default='{}/datasets/train_set.seg_y_dev.txt'.format(BASE_DIR), help="train_seg_y_dir")
    parser.add_argument("--test_seg_x_dir", default='{}/datasets/test_set.seg_x_dev.txt'.format(BASE_DIR), help="test_seg_x_dir")
    parser.add_argument("--vocab_path", default='{}/datasets/vocab_dev.txt'.format(BASE_DIR), help="Vocab path")
    parser.add_argument("--word2vec_output", default='{}/datasets/word2vec_dev.txt'.format(BASE_DIR), help="Vocab path")
